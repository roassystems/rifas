...
const uploadFilesMongo = async (req, res) => {
  try {
    await uploadMongo(req, res);
...
const uploadFilesServer = async (req, res) => {
  try {
...
const getListFilesServer = async (req, res) => {
  try {
...
const downloadMongo = async (req, res) => {
  try {
    await mongoClient.connect();
